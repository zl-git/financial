			...
			<div class="content base">
				...
				<table>
					...
					<tr>
						...
						<td>
							<div class="form-group">
								...
								<c:if test="${fn:contains(case.industry, \"其他\")}">
									<option selected>${case.industry}</option>
								</c:if>
						...
						<td>
							<div class="form-group">
								...
								<c:if test="${fn:contains(case.raiseType, \"其他\")}">
									<option selected>${case.raiseType}</option>
								</c:if>
					...
					<tr>
						...
						<td>
							<div class="form-group">
								...
								<c:if test="${fn:contains(case.serviceType, \"其他\")}">
									<option selected>${case.serviceType}</option>
								</c:if>
									        ...
									        url: "<%=request.getContextPath()%>/home/ajax/add",
									      	...
									      	dataType : "text",
									       	 success: function(data){
									       		...
									       		var p ;
									       		$("#serviceTypes").append("<option value=''></option>");
					...
					<tr>
						<td><p>涉及地区</p></td>
						<td>
						    <div id="picker3" class="picker form-group">
							  <sf:input type="text" class="form-control region-picker"  data-remote="${pageContext.request.contextPath}/assets/json" data-picked="北京市,东城区" data-visible="5" path="involveArea"/>
								<script>alert("1")</script>
								<%-- <sf:input type="text" class="form-control region-picker"  data-remote="${pageContext.request.contextPath}/assets/json" data-picked="新疆维吾尔自治区,喀什地区,巴楚县" data-visible="5" path="involveArea"/> --%>
							</div>
						...
						<td>
							<div class="form-group">
								<sf:input class="form-control caseTime" id="startTime" path="caseTime" />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
						   <div id="picker1" class="picker form-group">
							  <sf:input type="text" class="form-control region-picker"  data-remote="${pageContext.request.contextPath}/assets/json" data-picked="北京市,东城区" data-visible="5"  path="registerArea"/>
<%-- 							  <sf:input type="text" class="form-control region-picker"  data-remote="${pageContext.request.contextPath}/assets/json" data-picked="新疆维吾尔自治区,喀什地区,巴楚县" data-visible="5"  path="registerArea"/> --%>
						...
						<td>
						    <div id="picker2" class="picker form-group">
							  <sf:input type="text" class="form-control region-picker"  data-remote="${pageContext.request.contextPath}/assets/json" data-picked="北京市,东城区" data-visible="5"  path="caseArea"/>
					...
					<tr>
						...
						<td>
							<div class="form-group">
								...
								<c:if test="${fn:contains(case.channel, \"其他\")}">
									<option selected>${case.channel}</option>
								</c:if>
						...
						<td>
							<div class="form-group">
								...
								<c:if test="${fn:contains(case.caseGrade, \"其他\")}">
									<option selected>${case.caseGrade}</option>
								</c:if>
					...
					<tr>
						...
						<td>
							<div class="form-group">
								<sf:input class="form-control informant"  path="informant" />
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="form-group">
								<sf:input class="form-control formDate" id="fillData" path="formDate" />
							</div>
						</td>
					</tr>
				</table>
