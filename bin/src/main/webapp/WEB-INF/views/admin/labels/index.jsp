			...
			<div class="panel-body">
				...
				<section class="col-sm-9">
					<form class="form-horizontal" role="form"
						action="<%=request.getContextPath()%>/admin/industry/add"
						method="post">
						...
						<tbody>
							<c:forEach items="${industries}" var="industry" varStatus="stat">
								<tr>
									...
									<td><a
										href="<%=request.getContextPath()%>/admin/industry/del?industryId=${industry.industryId}"
